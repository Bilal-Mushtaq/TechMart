  ...
  return (
    <Box>
      <Flex justify="flex-end" align="center" position="relative">
        ...
        <HeroSection
          mainText={"Premium Tech Store in Pakistan."}
          subText={
      ...
      <Box fontSize="14px" px={[null, "10px", "5%", "10%"]} m="10% 0 50px 0">
        ...
        >
          ...
          >
            <Box p="50px">
              <Text fontWeight="600">KEYBOARD</Text>
              <Text fontWeight="600" color="brand.900" mb="20px">
        ...
        <Flex justify="space-between" flexWrap="wrap">
          <Box w={[null, "100%", "40%"]} p="5%" ps={["5%", "5%", 0]}>
            ...
            <Text fontSize="14px" fontWeight="600" mb="35px">
              Ea dolore culpa Lorem laborum aliqua amet laboris pariatur
              deserunt cillum ex non reprehenderit. Culpa do do esse aliqua
              tempor nulla. Eiusmod ut reprehenderit aliqua quis enim laborum
              sit anim exercitation. Ea enim ut id officia labore voluptate
              nostrud. Voluptate aute nostrud ullamco laboris ex officia sit.
            </Text>
            <Link
              href="/Shop"
              fontSize="14px"
